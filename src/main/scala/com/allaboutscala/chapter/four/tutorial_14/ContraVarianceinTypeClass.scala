package com.allaboutscala.chapter.four.tutorial_14

object ContraVarianceinTypeClass extends App {
    ...
    class Shoppingcart[-D <: Donut](shoppingcart:Seq[D]){ // Shoppingcart[-D<: Donut] is the contra variance to allow creation of Donut object under vanilla donut class
    ...
    val shoppingcartobj3:Shoppingcart[VanillaDonut]=new Shoppingcart[Donut](Seq(vanilla)) //this will work only when the contra variance is enabled Shoppingcart[-D<: Donut]
