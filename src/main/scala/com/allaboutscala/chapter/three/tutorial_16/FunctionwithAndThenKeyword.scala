package com.allaboutscala.chapter.three.tutorial_16

object FunctionwithAndThenKeyword extends App{
...
println("Step1:Calling the functions separately ")
  ...
  println(s"Calling Coupon and tax functions ${(applycoupon andThen applytax)(17.00)}")
}
